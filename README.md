...
| Energy        | **GoodWe (Cloud / SEMS Portal)** | Remote monitoring via the GoodWe SEMS Portal using your account login; requires a GoodWe HomeKit or smart meter for grid and consumption readings                                                                                                                                                        |
