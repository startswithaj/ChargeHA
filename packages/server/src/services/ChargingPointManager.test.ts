...
describe("ChargingPointManager", () => {
  ...
  // ensureVehicleChargingPoint, syncVehicleChargingPoints, and control-path
  // switching have their own file — see
  // ChargingPointManager.vehicleControlPath.test.ts — to keep this file
  // under the test-file-length limit.
