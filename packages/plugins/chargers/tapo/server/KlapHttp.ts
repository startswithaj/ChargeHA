...
// exchange: Tapo's "SHIP 2.0" server matches `Content-Length` case-sensitively
// (WHATWG fetch always lowercases it, so real fetch can never complete a handshake). Verified on a P110(AU), firmware 1.4.x.
