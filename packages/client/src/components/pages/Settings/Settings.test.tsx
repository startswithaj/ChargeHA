...
describe("Settings", () => {
  ...
  describe("Setup Wizard button", () => {
    it("renders 'Run Setup Wizard' button when wizard not completed", async () => {
      mockWizardStatusUseQuery.mockReturnValue({
        data: {
          completed: false,
          firstRun: false,
        },
    ...
    it("renders 'Re-run Setup Wizard' button when wizard previously completed", async () => {
      mockWizardStatusUseQuery.mockReturnValue({
        data: {
          completed: true,
          firstRun: false,
    ...
    it("clicking button navigates to /wizard", async () => {
      mockWizardStatusUseQuery.mockReturnValue({
        data: {
          completed: false,
          firstRun: false,
